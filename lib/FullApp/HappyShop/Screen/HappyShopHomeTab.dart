...
import 'package:smartkit/FullApp/HappyShop/widget/ProductBelowSec.dart';
...
class HappyShopHomeTab extends StatefulWidget {
  HappyShopHomeTab({Key key}) : super(key: key);

  @override
  _HappyShopHomeTabState createState() => _HappyShopHomeTabState();
}

class _HappyShopHomeTabState extends State<HappyShopHomeTab>
                ...
                child: SafeArea(
                  child: Column(
                    children: [
                      ...
                      //                         children: [
                      //                           CircleAvatar(
                      //                             backgroundImage: AssetImage('assets/image/micon.png'),
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ImageIcon(
                                    AssetImage('assets/image/micon.png'),
                                    size: 32,
                                  ),
                                  SizedBox(
                                    height: 2.0,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) =>ProDuctDownSec()));
                              },
                              child: Padding(
                                ...
                                child: GridView.count(
                                    ...
                                    children: List.generate(
                                      ...
                                      (index) {
                                        return ItemCard(
                                          tag: "${index}2",
                                          imagurl: sectList[0]['productList']
                                              [index]['img'],
                                          itemname: sectList[0]['productList']
                                              [index]['name'],
                                          descprice: sectList[0]['productList']
                                              [index]['descprice'],
                                          price: sectList[0]['productList'][index]
                                              ['price'],
                                          rating: sectList[0]['productList']
                                              [index]['rating'],
                                          shadow: false,
                                        );
                                      },
                                ...
                                child: GridView.count(
                                    ...
                                    children: List.generate(
                                      ...
                                      (index) {
                                        return ItemCard(
                                          tag: "${index}1",
                                          imagurl: sectList[2]['productList']
                                              [index]['img'],
                                          itemname: sectList[2]['productList']
                                              [index]['name'],
                                          descprice: sectList[2]['productList']
                                              [index]['descprice'],
                                          price: sectList[2]['productList'][index]
                                              ['price'],
                                          rating: sectList[2]['productList']
                                              [index]['rating'],
                                          shadow: false,
                                        );
                                      },
