                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text(
                        CUR_CURRENCY + "10180",
                        style: Theme.of(context).textTheme.subtitle1.copyWith(fontWeight: FontWeight.bold, color: Color(0xFFF68628)),
                      )
                    ],
                  ),
                ),
                      ...
                      children: [
                          ...
                          child: ElevatedButton(onPressed: (){
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('Process to checkout', style: TextStyle(
                                fontWeight: FontWeight.normal
                                ),
                                )
                              ],
                            ),
                            style: ElevatedButton.styleFrom(primary: Color(0xFF0C3A66)),
                          ),
                        ),
                        SizedBox(
                          width: 12,
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(onPressed: (){},
                            ...
                            style: ElevatedButton.styleFrom(primary: Color(0xFFF68628)),
                          ),
                        ),
                        // SizedBox(
                        //   width: 8,
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Spacer(),
                        Text(cartList[index]['totle'], style: Theme.of(context).textTheme.headline6.copyWith(color: Color(0xFFF68628)),)
                      ],
                    )
                  ],
                ),
