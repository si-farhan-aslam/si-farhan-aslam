...
class HappyShopPeofile extends StatefulWidget {
  bool appbar = false;
  HappyShopPeofile({Key key,this.appbar}) : super(key: key);
  ...
  getAppBar(String title, BuildContext context) {
    return AppBar(
      leading: IconButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => HappyShopHome()));
        }
      ),
      title: Text(
        title,
