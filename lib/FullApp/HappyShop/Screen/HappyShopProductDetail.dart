                ...
                children: [
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      style:
                          ElevatedButton.styleFrom(primary: Color(0xFF0C3A66)),
                    ),
                  ),
                  SizedBox(
                    width: 12,
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      style:
                          ElevatedButton.styleFrom(primary: Color(0xFFF68628)),
                    ),
                  ),
                  SizedBox(
                    width: 8,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Chat",
                          style:
                              TextStyle(fontSize: 12, color: Color(0xFFF68628)),
                        )
                      ],
                    ),
                  )
        ...
        children: [
          Row(
            children: <Widget>[
              ...
              // TextButton(onPressed: null, child: Text('Bargain'))
            ],
          ),
          Container(
            margin: EdgeInsets.only(left: 10),
